...
import bean_utils.WXPayConstants;
import bean_utils.WXPayUtil;
...
@WebServlet(name = "WechatServletServlet",urlPatterns = "/wechat")
public class WechatServletServlet extends HttpServlet {
    private String appid = "wx800cc7b80f3ea3c2";
    private String secretKey = "c94ce6608a70b16569b3fb38611cb814";
    @Override
    ...
    public static String getReqStr(String openid){
        ...
        //
        String appid = "wx800cc7b80f3ea3c2";
